...
const startDrag = (table: Entity, event: MouseEvent) => {
  ...
  dragDataLocal.offsetX = event.clientX - (table.xAxis! * props.scale - props.viewBox.x * props.scale);
  dragDataLocal.offsetY = event.clientY - (table.yAxis! * props.scale - props.viewBox.y * props.scale);
