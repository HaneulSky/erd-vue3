...
import CanvasMarkers from './Canvas/CanvasMarkers.vue';
import type { Entity, Relation } from '@/features/erd/types/Table.model'
import CanvasRelations from './Canvas/CanvasRelations.vue';
import CanvasTables from './Canvas/CanvasTables.vue';
import CanvasZoom from './Canvas/CanvasZoom.vue';
...
const onScaleButton = ({ viewBox, scale }) => {
